    ...
    <div className="mt-6">
      <div className="card max-w-2xl mx-auto">
        <div className="flex items-center gap-6">
          <div className="w-28 h-28 bg-gray-100 rounded-full overflow-hidden border">
            {previewSrc ? (
          ...
          <div>
            ...
            <div className="muted">Member since {new Date(user.created_at).toLocaleDateString()}</div>
          </div>
        </div>
        ...
        <div className="mt-6">
          ...
          <form onSubmit={handleUpdate} className="grid grid-cols-1 gap-3 mt-4" aria-labelledby="profile-heading">
            ...
            <div>
              ...
              <textarea id="profile-bio" name="bio" defaultValue={profile.bio} className="form-input" />
            </div>
            <div>
              <label htmlFor="profile-picture" className="form-label">Profile picture</label>
              <input id="profile-picture" type="file" name="profile_picture" aria-label="Profile picture" className="form-input" onChange={handleFileChange} />
            </div>
